...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.author = 'MUHAMMAD AHYAN NOOR'
        //global.author = 'Ahyan'
        global.wm2 = global.data.namabot + ' ' + global.data.owner
        global.wm = namabot + ' ву Muhammad Ahyan Noor'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'ʙy Muhammad Ahyan Noor '
        global.kontak2 = [
        ['628884357769', 'YanzBotz', 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'ahyanmhmdd@gmail.com', true],
        ['628884357769', 'YanzBotz', 'Bot WhatsApp', 'Nothing!', true],
        ['628884357769', 'Yanz', 'Bot WhatsApp', 'Nothing!', true],
        ['628884357769', 'Yanz', 'Bot WhatsApp', 'Nothing!', true],
        ['628884357769', 'Yanz', 'Bot WhatsApp', 'Nothing!', true],
        ['628884357769', 'Yanz', 'Bot WhatsApp', 'Nothing!', true],
        ['628884357769', 'Yanz', 'Bot WhatsApp', 'Nothing!', true],
   ...
   await conn.sendButtonDoc(id, text, wm, action == 'add' ? 'selamat datang' : 'sampai jumpa', action === 'add' ? '.intro' : 'Muhammad Ahyan Noor', fkontak,{
