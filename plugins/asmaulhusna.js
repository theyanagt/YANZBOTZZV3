...
Meaning: "Memang, Allah memiliki sembilan puluh sembilan nama, alias seratus kurang dari satu. Siapa pun yang menghitungnya, pasti akan masuk surga; Dia adalah Witr dan mencintai Witr.`
...
let handler = async (m, { args, usedPrefix, command }) => {
    ...
    if (args[0]) {
        if (args[0] < 1 || args[0] > 99) throw `minimum 1 & max 99!`
